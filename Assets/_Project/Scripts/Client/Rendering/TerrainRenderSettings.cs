...
namespace DigBlocks.Client.Rendering
{
    ...
    public sealed class TerrainRenderSettings : ScriptableObject
    {
        ...
        //chunk slot capacity and draw distance are not authored here: both are derived from the
        //streaming view distance, so one authored number drives what is streamed and what is drawn.
