...
| Writing a new world type | `Generators/DemoGenerator.cs`, a commented reference using every feature |
...
| Entity position, world coordinates, or ghost field precision | `docs/entity-foundation.md` coordinates and replication sections, then `Scripts/Simulation/Coordinates` |
